...
Если OpenRouter включен, для проектов, прошедших фильтры, бот также генерирует
черновик отклика и отправляет его отдельным сообщением в Telegram. Это только текстовый
черновик: бот не отправляет отклик на Kwork от вашего имени.
